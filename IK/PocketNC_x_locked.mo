...
model PocketNC_x_locked
  Modelica.Mechanics.MultiBody.Joints.Revolute b_axis(a(fixed = false), n = {0,  -1,0}, phi(fixed = true, start = 0.174533), useAxisFlange = true, w(fixed = false, start = 0))  annotation(
  ...
  Modelica.Mechanics.Rotational.Components.Damper b_damper(d = 1e-3)  annotation(
    Placement(visible = true, transformation(origin = {-72, -74}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Mechanics.Rotational.Components.Damper a_damper(d = 10)  annotation(
  ...
  IK.ControlInterfaceUtilities.ControlInterface controlInterface1(tolerance_i = {0.0006, 0.0006},tool_tip_orientation_i = {0, 0, 0.50}, tool_tip_position_i = {0, -1e-6,0})  annotation(
  ...
  IK.Limiter limiter1(k = 1000, lower_limit = -25 * Modelica.Constants.pi / 180, upper_limit = 136 * Modelica.Constants.pi / 180)  annotation(
  ...
  Limiter b_limiter(k = 0, lower_limit = -10000, upper_limit = 10000 * Modelica.Constants.pi / 180)  annotation(
  ...
  Modelica.Blocks.Sources.Constant x_position(k = 0)  annotation(
...
equation
  ...
  connect(b_damper.flange_a, b_axis.support) annotation(
    Line(points = {{-82, -74}, {-90, -74}, {-90, -38}, {-76, -38}, {-76, -40}}));
  connect(b_axis.axis, b_damper.flange_b) annotation(
    Line(points = {{-70, -40}, {-70, -38}, {-52, -38}, {-52, -74}, {-62, -74}}));
  ...
  connect(b_damper.flange_b, b_angle_sensor.flange) annotation(
    Line(points = {{-62, -74}, {-52, -74}, {-52, -88}, {-114, -88}, {-114, -104}, {-104, -104}}));
  ...
  connect(z_axis.frame_a, y_axis.frame_b) annotation(
    Line(points = {{60, 32}, {52, 32}, {52, -6}, {80, -6}, {80, -50}, {60, -50}, {60, -50}}));
  connect(x_position.y, controlInterface1.machine_position[1]) annotation(
    Line(points = {{-168, 68}, {-156, 68}, {-156, 38}, {-186, 38}, {-186, -16}, {-164, -16}, {-164, -16}}, color = {0, 0, 127}));
  annotation(
    Diagram(coordinateSystem(extent = {{-200, -200}, {200, 200}})),
    Icon(coordinateSystem(extent = {{-200, -200}, {200, 200}})));end PocketNC_x_locked;